    ...
    <>
      ...
      <div className="w-full flex ">
        ...
        >
          ...
          real-world examples of my work. Each project is live on the internet
          to have a better glance and look. It reflects my ability to solve
          complex problems, work with different technologies,and manage projects
          effectively.
        </motion.p>
      </div>
      <div className=" mt-6 mr-5 flex flex-wrap gap-7">
